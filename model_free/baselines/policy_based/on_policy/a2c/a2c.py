"""Factory entrypoint for continuous-action A2C.

This module provides :func:`a2c`, a convenience constructor that assembles:

- :class:`A2CHead` (actor + critic networks),
- :class:`A2CCore` (optimization/update logic),
- :class:`OnPolicyAlgorithm` (rollout collection and scheduling).
"""
